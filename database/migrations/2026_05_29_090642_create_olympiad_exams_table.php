...
return new class extends Migration
{
    ...
    {
        Schema::create('olympiad_exams', function (Blueprint $table) {
            $table->id();
            $table->string('judul');
            ...
            $table->string('tingkat', 50)->nullable()->comment('kabupaten/provinsi/nasional');
    ...
    {
        Schema::dropIfExists('olympiad_exams');
    }
};
