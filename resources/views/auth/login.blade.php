<x-guest-layout>
    ...
    <style>
        ...
        .principal-tagline::after {
            ...
            background: linear-gradient(90deg, rgba(255, 255, 255, 0.2), #ffe082, rgba(255, 255, 255, 0.2));
    ...
    <div class="uni-login-page" style="overflow: hidden; height: 100vh; max-height: 100vh; position: relative;">
        <div class="uni-bg-curve"
            ...
            <svg id="visual" viewBox="0 0 900 600" width="100%" height="100%" preserveAspectRatio="none"
                ...
                <path
                    d="M443 0L457.7 14.3C472.3 28.7 501.7 57.3 512 85.8C522.3 114.3 513.7 142.7 492.5 171.2C471.3 199.7 437.7 228.3 414.5 257C391.3 285.7 378.7 314.3 395.7 343C412.7 371.7 459.3 400.3 474.3 428.8C489.3 457.3 472.7 485.7 460.7 514.2C448.7 542.7 441.3 571.3 437.7 585.7L434 600L0 600L0 585.7C0 571.3 0 542.7 0 514.2C0 485.7 0 457.3 0 428.8C0 400.3 0 371.7 0 343C0 314.3 0 285.7 0 257C0 228.3 0 199.7 0 171.2C0 142.7 0 114.3 0 85.8C0 57.3 0 28.7 0 14.3L0 0Z"
            ...
            <div class="uni-left"
                ...
                <div class="principal-feature">
                    ...
                    <p class="principal-tagline">
                        mewujudkan cendekiawan Muslim yang berlandaskan <strong>IMTAQ</strong> (Iman dan Ketaqwaan)
                        dan <strong>IPTEK</strong> (Ilmu Pengetahuan dan Teknologi)
                    </p>
                </div>
            </div>
            <div class="uni-right"
                        ...
                        <div id="login-view" class="form-view active-view">
                            <div class="tester-tip-badge">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546 5.974 5.974 0 01-2.133-1A3.75 3.75 0 0012 18zM12 18V9.75M12 9.75a3.75 3.75 0 110-7.5 3.75 3.75 0 010 7.5z" />
                                </svg>
                            ...
                            <form method="POST" action="{{ route('login') }}" id="login-form">
                                ...
                                <div class="uni-input-group">
                                    <input type="email" id="email" name="email" placeholder=" "
                                        ...
                                        class="uni-input-field @error('email') input-error @enderror">
                                    <label class="uni-label">Email</label>
                                    <span class="uni-input-icon"
                                        style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); color: #FF7A60; font-size: 16px; font-weight: 600; pointer-events: none; user-select: none;">@</span>
                                    @error('email')
                                        <div style="color: #ef4444; font-size: 11px; margin-top: 5px; font-weight: 500;">
                                            {{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="uni-input-group" style="position: relative;">
                                    ...
                                    <button type="button" onclick="togglePasswordVisibility('password', 'eye-icon')"
                                        class="uni-input-icon"
                                        style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; color: #94a3b8; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; outline: none; transition: color 0.2s;">
                                ...
                                <div class="uni-remember-row"
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}"
                                            style="color: #FF7A60; text-decoration: none; font-size: 12.5px; font-weight: 600;">Recovery
                                            Password</a>
                                    @endif
                                </div>
                                <div class="uni-role-selector" style="margin-bottom: 20px;">
                                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
                                        ...
                                        <button type="button" onclick="selectRole('kepala_sekolah')"
                                            id="role-kepala_sekolah" class="uni-role-btn">
                                            Kepala Sekolah
                                        </button>
                                        <button type="button" onclick="selectRole('guru')" id="role-guru"
                                            class="uni-role-btn">
                                            Guru
                                        </button>
                                        <button type="button" onclick="selectRole('siswa')" id="role-siswa"
                                            class="uni-role-btn"
                                            style="border: 1.5px solid #FF7A60; background: #fff5f3; color: #FF7A60;">
                                            Siswa
                                        </button>
                                    </div>
                                ...
                                <button type="button" class="uni-google-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
                                        ...
                                        <path fill="#4285F4"
                                            d="M46.5 24c0-1.55-.15-3.24-.47-4.77H24v9.03h12.75c-.55 2.92-2.2 5.4-4.69 7.07l7.29 5.65C43.6 36.42 46.5 30.73 46.5 24z" />
                                        <path fill="#FBBC05"
                                        ...
                                        <path fill="#34A853"
                                            d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.29-5.65c-2.02 1.35-4.61 2.16-8.6 2.16-6.26 0-11.57-4.22-13.46-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z" />
                                    </svg>
                                    Sign in with Google
                                </button>
                            </form>
                            <div class="uni-footer-link" style="text-align: center; font-size: 13px; color: #94a3b8;">
                                Don't have an account yet? <a href="{{ route('register') }}"
                                    ...
                                    style="color: #FF7A60; text-decoration: none; font-weight: 700; margin-left: 4px;">Sign
                                    Up</a>
                            </div>
                        </div>
                        <div id="register-view" class="form-view" style="display: none; opacity: 0;">
                            <form method="POST" action="{{ route('register') }}" id="register-form">
                                ...
                                <div class="uni-input-group">
                                    <input type="text" id="name" name="name" placeholder=" "
                                        ...
                                        class="uni-input-field @error('name') input-error @enderror">
                                ...
                                <div class="uni-input-group" style="position: relative;">
                                    ...
                                    <label class="uni-label">Password</label>
                                    <button type="button"
                                        onclick="togglePasswordVisibility('register_password', 'eye-icon-pw')"
                                        class="uni-input-icon"
                                        style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; color: #94a3b8; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; outline: none; transition: color 0.2s;">
                                        <svg id="eye-icon-pw" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor"
                                            style="width: 18px; height: 18px;">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                            ...
                            <div class="uni-footer-link"
                                ...
                                Already registered? <a href="{{ route('login') }}"
                                    onclick="toggleAuthPage(event, 'login')"
