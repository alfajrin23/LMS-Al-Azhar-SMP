<div class="content-header">
    ...
    <div class="header-right"><label @click="showTulisPesan = !showTulisPesan" class="header-btn primary"
            style="cursor:pointer"><i class="fas fa-envelope"></i> Pesan Baru</label>
...
<div x-show="showTulisPesan" class="card" style="margin-bottom:16px">
    <div class="card-header">
        <h3><i class="fas fa-paper-plane" style="color:var(--teal)"></i> Kirim Pesan ke Guru</h3>
    </div>
    <form method="POST" action="{{ route('siswa.pesan.store') }}" style="padding:4px 0">
        ...
        <button type="submit" class="btn-login" style="cursor:pointer;border:none"><i class="fas fa-paper-plane"></i>
            Kirim</button>
...
<div class="card">
    <div class="card-header">
        <h3><i class="fas fa-inbox" style="color:var(--blue)"></i> Kotak Masuk</h3>
    </div>
                ...
                @forelse($pesan as $m)
                    <tr>
                        ...
                        <td><label
                                ...
                                class="btn-small outline" style="cursor:pointer">Balas</label></td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="4" style="text-align:center;color:var(--gray-400)">Tidak ada pesan</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
...
<div x-show="showReplyForm" class="card" style="margin-bottom:16px">
    <div class="card-header">
        <h3><i class="fas fa-reply" style="color:var(--blue)"></i> Balas Pesan — <span x-text="replyTo"></span></h3>
    </div>
    <form method="POST" action="{{ route('siswa.pesan.store') }}" style="padding:4px 0">
        @csrf
        ...
        <button type="submit" class="btn-login" style="cursor:pointer;border:none"><i class="fas fa-reply"></i> Kirim
            Balasan</button>
